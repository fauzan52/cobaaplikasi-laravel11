...
@section('container')
    ...
    <form method="post" action="/dashboard/posts/{{ $post->slug }}" class="mb-5">
        ...
        <div class="mb-3">
            ...
            <input type="title" class="form-control @error('title') is-invalid @enderror"  id="title" name="title" value="{{ old ('title', $post->title) }}">
            @error('title')
        ...
        <div class="mb-3">
            ...
            <input type="slug" class="form-control @error('slug') is-invalid @enderror"  id="slug" name="slug"  value="{{ old ('title', $post->slug) }}" disable readonly>
            @error('slug')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
